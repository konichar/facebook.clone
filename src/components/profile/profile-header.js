...
import { Box, Container, Button, Divider, Avatar, Badge, IconButton, Tabs, Tab, Toolbar } from '@material-ui/core'
import { makeStyles, withStyles } from '@material-ui/core/styles'
import { CameraAlt, Edit, Visibility, Search, MoreHoriz } from '@material-ui/icons';
...
const useStyles = makeStyles((theme) => ({
    ...
    headerbox: {
        ...
        backgroundImage: 'url("https://res.cloudinary.com/konichar/image/upload/v1617396187/projects/p2_ecmrau.jpg")',
        ...
        <Box className={classes.header}>
            <Container maxWidth="lg">
                <Box className={classes.headerbox} display="flex" justifyContent="center" alignItems="flex-end" borderRadius={10}>
                    <Box mb={-2} >
                        <Badge
                            ...
                            badgeContent={
                                <IconButton aria-label="upload picture" component="span" className={classes.iconButton} size="small">
                ...
                <Box display="flex" p={1} pt={2} lineHeight={1} bgcolor="secondary.dark" alignItems="center" flexDirection="column" className={classes.headertitle}>
                    ...
                    <Button color="primary" size="small" href="#text-button" className={classes.editbtn}>Edit</Button>
                </Box>
                <Divider className={classes.divider} ></Divider>
                <Toolbar display="flex">
                    <Tabs value={value} onChange={handleChange} aria-label="profile tabs" className={classes.tabtoolbar} indicatorColor="primary">
                        <Tab label="Posts" {...a11yProps(0)} className={classes.tab} />
                        <Tab label="About" {...a11yProps(1)} className={classes.tab} />
                        <Tab label="Friends 595" {...a11yProps(3)} className={classes.tab} />
                        <Tab label="Photos" {...a11yProps(4)} className={classes.tab} />
                        <Tab label="Story Archive" {...a11yProps(5)} className={classes.tab} />
                        <Tab label="Videos" {...a11yProps(6)} className={classes.tab} />
                        <Tab label="More" {...a11yProps(7)} className={classes.tab} icon={<Search />}/>
                    </Tabs>
